    ...
    <div class="container page-container" style="min-height: 700px">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p style="text-indent:2em;">We are the only distributor of surgical product from Pro-Med Instrumente GmbH in China. We also sell and do promotion activities for SurgiTel products in south China (7 provinces). We provide following products for our clients: virus nucleic acid detection, detection of infection disease, FISH, cancer gene mutation, resistant gene mutation, HLA genotyping and transplantation immunology drug monitoring. </p>
