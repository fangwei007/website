        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled list-inline list-social-icons">
                    <li>
                        <button class="btn-default" style="border-color: transparent;" data-container="body" data-toggle="popover" data-placement="bottom" data-trigger="hover focus" data-html="true" data-content='<img src="/images/QR.png" width=80/>'><i class="fa fa-weibo fa-2x"></i></button>
                    </li>
                    <li>
                        <button class="btn-default" style="border-color: transparent;" data-container="body" data-toggle="popover" data-placement="bottom" data-trigger="hover focus" data-html="true" data-content='<img src="/images/QR.png" width=80/>'><i class="fa fa-weixin fa-2x"></i></button>
                    </li>
                    <li>
                        <button class="btn-default" style="border-color: transparent;" data-container="body" data-toggle="popover" data-placement="bottom" data-trigger="hover focus" data-html="true" data-content='<img src="/images/QR.png" width=80/>'><i class="fa fa-qq fa-2x"></i></button>
                    </li>
                </ul>
            </div>
        </div>
