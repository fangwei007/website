...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"下一页",sPrevious:"前一页"},sEmptyTable:"No data available in table",sInfo:"正在显示 _START_ 到 _END_ ，共 _TOTAL_ 记录",sInfoEmpty:"正在显示 0 记录",sInfoFiltered:"(从 _MAX_ 条总记录里)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 记录",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"查找: ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"未找到相关记录"},oSearch:h.extend({},
